#!/usr/env/python 3.5
# -*-coding:utf-8-*-
# many thanks to https://github.com/Nemzy/video_generator
...
def read_dataset(path, test_size):
    ...
    images = read_images([os.path.join(dirpath, filename) for filename in filenames if filename.endswith(".png")])
...
if __name__ == '__main__':
    print(os.getcwd())
    train_ds, test_ds = read_dataset('.\\imgdata', 0.097)
